...
export function MediaCard({ media }: { media: MediaStorage }) {
  ...
  return (
    <div className="relative flex flex-col gap-1 p-4 bg-white rounded-2xl squircle border-2 border-blue shadow-[0_4px_0_0_#2e6aad] hover:translate-y-px hover:shadow-[0_3px_0_0_#2e6aad] active:translate-y-1 active:shadow-none transition-transform">
