          ...
          {sections.map((section) => {
            ...
            return (
              <Link
                key={section.href}
                href={section.href}
                className="rounded-2xl squircle border-2 border-black/10 bg-white p-6 text-center shadow-[0_4px_0_0_rgba(0,0,0,0.06)] hover:shadow-[0_3px_0_0_rgba(0,0,0,0.06)] hover:translate-y-px transition-transform"
              >
                <div
