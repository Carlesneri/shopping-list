...
function NavCard({
  ...
  return (
    <Link
      href={href}
      className={`relative group flex items-center gap-4 p-5 rounded-3xl squircle ${bgColors[color] || bgColors.purple} ${textColors[color] || textColors.purple} ${shadowColors[color] || shadowColors.purple} transition-all duration-200 hover:translate-y-px active:translate-y-1 active:shadow-none w-full max-w-lg`}
    >
